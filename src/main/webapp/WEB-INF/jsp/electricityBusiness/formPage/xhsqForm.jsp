...
<div class="col-lg-12">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <form id="xhsqForm" class="form-horizontal" method="post" action="<%=path %>/powerBusinessInfo/add.do">
                <input type="hidden" name="mapVo['businessType']" value="xhsq"/>
                ...
                <div class="text-center">
                    <p>
                        <button type="submit" form="xhsqForm" class="btn btn-primary">
