    ...
    <div class="jumbotron">
        <div class="container">
            <p style="font-size: 14px;">
                您需要提供资料：客户报装申请、身份证复印件、总表当月电费发票复印件（限总表供电用户）、房产证复印件（土地使用证明）。
            </p>
        </div>
    </div>
</div>
<div class="col-lg-12">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <form id="xzsqForm" class="form-horizontal" method="post" action="powerBusinessInfo/add.do">
                <input type="hidden" name="mapVo['businessType']" value="xzsq" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="address" placeholder="请输入您的地址" name="mapVo['electricityAddress']">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="text-center">
                    <p>
                        <button type="submit" form="xzsqForm" class="btn btn-primary">
