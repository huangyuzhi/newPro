...
<div class="col-lg-12">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <form id="zcsqForm" class="form-horizontal" method="post" action="<%=path %>/powerBusinessInfo/add.do">
                <input type="hidden" name="mapVo['businessType']" value="zcsq"/>
                ...
                <div class="form-group">
                    <label for="migration" class="col-sm-2 control-label">暂拆原因</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="migration" placeholder="请输入暂拆原因" name="mapVo['dismantleReason']">
                    </div>
                </div>
                ...
                <div class="text-center">
                    <p>
                        <button type="submit" form="zcsqForm" class="btn btn-primary">
